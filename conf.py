...
# documentation.
html_theme_options = {"pre_bg": "#c3f69a"}
...
# of the sidebar.
html_logo = '_static/logo_tangocontrols.png'
...
man_pages = [
    (master_doc, 'Tango Controls Documentation', u'Tango Controls Documentation',
     [author], 1)
]
